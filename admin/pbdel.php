...
if ($_POST)
    ...
    */
    ...
    $V_SW_DELETE=$V_OBJPB->delete_phonebook();
    if ($V_SW_DELETE==1)
        {
        ...
        <div class="alert alert-danger alert-dismissible" role="alert">
            ...
            <strong>Failed to Delete Record!</strong> Please try later.
        </div>';
        exit;
        }            
    }
...
$V_STR_NOMUSER=$_SESSION['user_name'];
$_SESSION['field_locked']="disabled";
include_once("../view/header2_inc.php");
include_once("../view/formPBD_inc.php");
?>