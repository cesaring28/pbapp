        ...
        <div id="maincontent" class="span8"> 
            <form id="form-pb" class="form-horizontal" method="post">
              ...
              <div class="form-control-group">
                ...
                <div class="controls">
                  <input type="text" class="input-xlarge" name="phone" id="phone" value="'.$V_NUM_PHONE.'" onkeypress="return event.charCode === 0 || /\d/.test(String.fromCharCode(event.charCode));" '.$V_STR_LOCK.'>
                </div>
              </div>
              ...
              <div class="form-control-group">
                ...
                <div class="controls">
                  <input type="text" class="input-xlarge" name="date_add" id="date_add" value="'.$V_FEC_DATEADD.'" placeholder="click to show datepicker" readonly>
                </div>
              </div>        
